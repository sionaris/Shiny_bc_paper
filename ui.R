          ...
          fluidRow(
            ...
            box(id = "Volcano_tuning_breast", title = "Volcano tuning", status = "warning", solidHeader = TRUE,
                ...
                colourpicker::colourInput("scatter_color_breast_NS", "Color for p>PVT (n.s. results)", 
                                          value = "#BEBEBE"),
                colourpicker::colourInput("scatter_color_breast_p_only", "Color for DE<|DET| & p<PVT", 
                                          value = "#FFC0CB"),
                colourpicker::colourInput("scatter_color_breast_downr", "Color for DE<-|DET| & p<PVT", 
                                          value = "royalblue"),
                colourpicker::colourInput("scatter_color_breast_upr", "Color for DE>|DET| & p<PVT", 
                                          value = "red4"),
                ...
                splitLayout(cellWidths = c("250px", "200px", "250px", "150px",
                            ...
                            selectInput(inputId = "breast_cancer_new_prediction_timepoint_annotation",
                                        ...
                                        choices = c("Preset", "Random", 
                                                    sort(c("Pre-treatment", "On-treatment"))),
                                        selected = "Random"),
                            # iC10
                            ...
                            selectInput(inputId = "breast_cancer_new_prediction_mammaprint_annotation",
                                        ...
                                        selected = "Random"),
                            # rorS
                            selectInput(inputId = "breast_cancer_new_prediction_rors_annotation",
                                        "rorS (Risk of relapse)", 
                                        choices = c("Preset", "Random", 
                                                    sort(c("High", "Intermediate", "Low"))),
                                        selected = "Random"),
                            # ROC plot (if possible: datasets with Response column)
                            radioButtons("breast_cancer_new_prediction_roc",
                                         "Produce ROC plot?",
                                         choices = c("Yes", "No"),
            ...
            box(id = "Custom_DGEA_control_panel", title = "Define DGEA subset", 
                ...
                splitLayout(cellWidths = c("350px", "300px", "500px",
                            ...
                            colourpicker::colourInput("scatter_color_breast_NS_custom", "Color for p>PVT (n.s. results)", 
                                                      value = "#BEBEBE"),
                            colourpicker::colourInput("scatter_color_breast_p_only_custom", "Color for DE<|DET| & p<PVT", 
                                                      value = "#FFC0CB"),
                            colourpicker::colourInput("scatter_color_breast_downr_custom", "Color for DE<-|DET| & p<PVT", 
                                                      value = "royalblue"),
                            colourpicker::colourInput("scatter_color_breast_upr_custom", "Color for DE>|DET| & p<PVT", 
                                                      value = "red4"),
