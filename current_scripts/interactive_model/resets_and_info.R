...
output$new_prediction_breast_info_text <- renderUI({
  HTML(paste0("<br> &#8226 Choose to either generate a random sample, import a sample with gene expression
              ...
              "<br> &#8226 Check out these GIF tutorials for short demonstrations:
              <ul>
                <li><a href='GIFs/newpred_unique_sample_genes_only.gif' target='_blank'>Unique sample (genes only)</a></li>
                <li><a href='GIFs/newpred_unique_sample_pre_annotated.gif' target='_blank'>Unique sample (pre-annotated)</a></li>
                <li><a href='GIFs/newpred_dataset.gif' target='_blank'>Dataset (pre-annotated)</a></li>
              </ul>"))
})
